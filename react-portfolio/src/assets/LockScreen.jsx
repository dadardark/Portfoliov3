    ...
    <div className={styles.appContainer}>
      <div className={styles.iphoneFrame}>
        <div className={styles.iphoneScreen}>
          ...
          <img src="https://img.icons8.com/?size=100&id=59825&format=png&color=000000" alt="Lock" className={styles.lockIcon} />

          <h2 className={styles.date}>{currentDate}</h2>
          <p>{currentTime}</p>

          <div className={styles.bottomButtonContainer}>
            <button className={styles.bottomButton} onClick={unlock}>
              <img src="https://img.icons8.com/?size=100&id=b327m2MVsQN5&format=png&color=000000" alt="Home Button" className={styles.bottomButtonIcon} />
            </button>
            <p className={styles.unlockText}>Hold finger to unlock</p>
          </div>
        </div>
      </div>
    </div>
